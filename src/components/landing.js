...
class Landing extends Component {
  constructor(){
    super();
    this.state ={
      imgArray: [svg, antMan, america, hawkEye, hulk, marvel, nebula, okoye, racoon, stark, thanos, thor, warMachine, widow ], 
      arrayIndex:0,
      characterName:'',
      characterTitle:'',
  ...
  render() {
    ...
    return (
      ...
      <div className="Landing">
        <div className="svg" > 
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"  viewBox="0 0 1600 900" xmlns="http://www.w3.org/1999/xhtml">
          ...
          <a onClick={e=> this.clickedCharacter(e, "Stark", 2)}>
          ...
          <a onClick={e=> this.clickedCharacter(e, "Thor", 13)}>
          ...
          <a onClick={e=> this.clickedCharacter(e, "Marvel", 7  )}>
          ...
          <a onClick={e=> this.clickedCharacter(e, "Hulk", 5)}>
          ...
          <a onClick={e=> this.clickedCharacter(e, "Widow", 14)}>
          ...
          <a onClick={e=> this.clickedCharacter(e, "Okoye", 9)}>
          ...
          <a onClick={e=> this.clickedCharacter(e, "HawkEye", 4)}>
          ...
          <a onClick={e=> this.clickedCharacter(e, "Racoon", 10)}>
          ...
          <a onClick={e=> this.clickedCharacter(e, "AntMan", 3)}>
          ...
          <a onClick={e=> this.clickedCharacter(e, "Nebulla", 8)}>
          ...
          <a onClick={e=> this.clickedCharacter(e, "", 6)}>
          <polygon fill="transparent" className="iron-parrot" points="922,514,958,567,941,596,900,588,843,510,781,449,799,414,905,471,972,523,941,465,928,411,910,421,908,472,908,437,920,492,948,500,948,437,944,435,942,420,951,448,945,435"></polygon>
          </a>
          <a onClick={e=> this.clickedCharacter(e, "", 12)}>
          ...
          <div xmlns="http://www.w3.org/1999/xhtml" className="text-container">
             <div xmlns="http://www.w3.org/1999/xhtml" className="character-name">{this.state.characterName}</div>
             <div xmlns="http://www.w3.org/1999/xhtml" className="character-title">{this.state.characterTitle}</div>
             <div xmlns="http://www.w3.org/1999/xhtml" className="character-description">{this.state.characterDescription}</div>
             </div>
          </foreignObject>
        </svg>
        </div>

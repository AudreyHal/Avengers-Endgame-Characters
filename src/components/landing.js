...
import iron_parrot from '../images/iron_parrot.jpg';
...
class Landing extends Component {
  constructor(){
    super();
    this.state ={imgArray: [svg, stark, america], arrayIndex:0}
  }
  clickedCharacter(e, name){
    e.preventDefault();
    console.log(name);
    this.setState({ arrayIndex: 2})
    ...
    return (
      ...
      <div className="Landing">
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 1600 900">
          ...
          <a onClick={e=> this.clickedCharacter(e, "Stark")}>
          ...
          <a onClick={e=> this.clickedCharacter(e, "Thor")}>
          ...
          <a onClick={e=> this.clickedCharacter(e, "Marvel")}>
          ...
          <a onClick={e=> this.clickedCharacter(e, "Hulk")}>
          ...
          <a onClick={e=> this.clickedCharacter(e, "Widow")}>
          ...
          <a onClick={e=> this.clickedCharacter(e, "Okoye")}>
          ...
          <a onClick={e=> this.clickedCharacter(e, "HawkEye")}>
          ...
          <a onClick={this.clickedCharacter.bind(this, "IronParrot")}>
          ...
          <a onClick={this.clickedCharacter.bind(this, "Thanos")}>

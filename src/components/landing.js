...
class Landing extends Component {
  ...
  componentDidMount(){
    ...
    setTimeout(()=>{this.setState({ loaderText: 'Preparing Assets'})}, 7000)
    setTimeout(()=>{this.setState({ loaderText: 'Getting everything set for you'})}, 20000)
    setTimeout(()=>{this.setState({ loaderText: 'Getting the Avengers suited'})}, 30000)
  ...
  render() {
    ...
    return (
      <div className="Landing">      
        ...
        {/* Preloader */}
        <div className="preloader-cover" style={ this.state.showLoader ? visibleStyle : hiddenStyle }>

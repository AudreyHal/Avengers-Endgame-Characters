      ...
      <div className="Landing">
        ...
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 1600 900">
         <image height="100%" width="100%" xlinkHref={this.state.imgArray[this.state.arrayIndex]}></image>
          ...
          <a onClick={e=> this.clickedCharacter(e, "Stark", 9)}>
          ...
          <a onClick={e=> this.clickedCharacter(e, "Thor", 11)}>
          ...
          <a onClick={e=> this.clickedCharacter(e, "Marvel", 5 )}>
          ...
          <a onClick={e=> this.clickedCharacter(e, "Hulk", 4)}>
          ...
          <a onClick={e=> this.clickedCharacter(e, "Widow", 13)}>
          ...
          <a onClick={e=> this.clickedCharacter(e, "Okoye", 7)}>
          ...
          <a onClick={e=> this.clickedCharacter(e, "HawkEye", 3)}>
          ...
          <a onClick={e=> this.clickedCharacter(e, "Racoon", 8)}>
          ...
          <a onClick={e=> this.clickedCharacter(e, "AntMan", 1)}>
          ...
          <a onClick={e=> this.clickedCharacter(e, "Nebulla", 6)}>
          ...
          <a onClick={e=> this.clickedCharacter(e, "WarMachine", 12)}>
          ...
          <a onClick={e=> this.clickedCharacter(e, "Thanos", 10)}>
